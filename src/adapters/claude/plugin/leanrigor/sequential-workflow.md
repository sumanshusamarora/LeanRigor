...
- Use the persisted `decision.question` and its options at every approval
  selector. Its bounded native preview is the visible approval context;
  `presentation.markdown` is for explicit detail requests.
